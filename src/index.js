...
(function(factory) {
   ...
   * <pre>
   * var FunctionsJs = require('index'); // See note below*.
   * var xxxSvc = new FunctionsJs.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new FunctionsJs.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new FunctionsJs.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new FunctionsJs.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
