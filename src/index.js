...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/App', 'model/AppWrapper', 'model/AppsWrapper', 'model/Error', 'model/ErrorBody', 'model/NewTask', 'model/Route', 'model/RouteWrapper', 'model/RoutesWrapper', 'model/Task', 'model/TaskWrapper', 'api/AppsApi', 'api/RoutesApi', 'api/TasksApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/App'), require('./model/AppWrapper'), require('./model/AppsWrapper'), require('./model/Error'), require('./model/ErrorBody'), require('./model/NewTask'), require('./model/Route'), require('./model/RouteWrapper'), require('./model/RoutesWrapper'), require('./model/Task'), require('./model/TaskWrapper'), require('./api/AppsApi'), require('./api/RoutesApi'), require('./api/TasksApi'));
  }
}(function(ApiClient, App, AppWrapper, AppsWrapper, Error, ErrorBody, NewTask, Route, RouteWrapper, RoutesWrapper, Task, TaskWrapper, AppsApi, RoutesApi, TasksApi) {
  'use strict';
